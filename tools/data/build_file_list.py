...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            'diving48', 'survai_var_mk1'
        ],
        help='dataset to be built file list')
    parser.add_argument(
        'src_folder', type=str, help='root directory for the frames or videos')
    # CUSTOM SURVAI ADDITION
    parser.add_argument(
        '--custom_annot_name', type=str, default=None, help='time code name of custom annotation csv --ex: 17-11-2021-13_29_45')
    parser.add_argument(
...
def main():
    ...
    # CUSTOM SURVAI ADDITIONS
    elif args.dataset in ['survai_var_mk1']:
        splits = parse_kinetics_splits(args.level, args.dataset, args.custom_annot_name)
