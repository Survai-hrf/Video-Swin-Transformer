...
def parse_kinetics_splits(level, dataset, custom_annot_name = ''):
    ...
    def line_to_map(x, test=False):
        ...
        return video, label
    if custom_annot_name != '':
        train_file = f'data/{dataset}/annotations/{custom_annot_name}_train.csv'
        val_file = f'data/{dataset}/annotations/{custom_annot_name}_val.csv'
        test_file = f'data/{dataset}/annotations/{custom_annot_name}_test.csv'
    else:
